...
class NetCDF2DGroup(object):
  ...
  def __setitem__(self, idx,value):
    ...
    tmshape,tcshape=getMasterShape(ishape,return_childshape=True,ncSize=12.0)
    # print(tmshape,tcshape)
    ...
    for part in tpartitions:
      # print(part)
      # for idim,i in enumerate(part):
      #   print(idim,i)
      #   value=i[idim]
        
        # print(part,i*tcshape[idim],np.minimum(tcshape[idim]*(i+1),ishape[idim]),i,tcshape[idim],idim,ishape)
